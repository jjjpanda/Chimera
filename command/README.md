...
- **Per username** — 10 tries per 15 minutes. A success refunds its slot; a failure does not. Once the budget is spent, nothing refunds it — a correct password gets the user in, but the throttle below stays on for the rest of the window.
