...
else if (rawGatewayHost !== "" && !/^https?:\/\//i.test(rawGatewayHost) && !isServiceOff(envLines, "command_COOKIE_SECURE") && process.env.command_COOKIE_SECURE === "true" && process.env.gateway_HTTPS_Redirect !== "true" && process.env.certbot_ON !== "true" && !LOOPBACK.includes(hostnameOf(gatewayHost()) || rawGatewayHost)) {
