...
if (!isServiceOff(envLines, "gateway_HOST") && !isServiceOff(envLines, "command_COOKIE_SECURE") && gwHost && !LOOPBACK.includes(gwHost) && process.env.command_COOKIE_SECURE !== "true") {
	if (httpsExpected) {
